...
<div id="contenido" style="height: 82%; 
    ...
    <form action='' method='GET' name='Ejer2' id='Ejer2'>
        ...
        <!-- Los dias se dividen en dos partes, a la segunda le restamos la primera -->
        ...
        <input class='dias' name='martes2' type='number' id='id_martes2' placeholder='Martes salida' />
        <br>
        <br>
        ...
        <input class='dias' name='jueves2' type='number' id='id_jueves2' placeholder='Jueves salida' />
        <br>
        <br>
        ...
        <input class='dias' name='sabado2' type='number' id='id_sabado2' placeholder='Sabado salida' />
        <br>
        <br>
